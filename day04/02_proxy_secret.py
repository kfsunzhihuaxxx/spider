...
class ProxyPool:
    def __init__(self):
        self.url = "http://dps.kdlapi.com/api/getdps/?orderid=948769263775384&num=100&pt=1&sep=1"
    ...
    def check_proxy(self,proxy):
        ...
        proxies = {
            'http':'http://sunzhihua0039：8p3owaf2@{}'.format(proxy),
            'https':'https://sunzhihua0039：8p3owaf2@{}'.format(proxy)
        }
        try:
